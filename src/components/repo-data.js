export default [
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/ace/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/ace/teams",
    hooks_url: "https://api.github.com/repos/defunkt/ace/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/ace/issues/events{/number}",
    ...
    git_commits_url:
      "https://api.github.com/repos/defunkt/ace/git/commits{/sha}",
    comments_url: "https://api.github.com/repos/defunkt/ace/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/ace/issues/comments{/number}",
    contents_url: "https://api.github.com/repos/defunkt/ace/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/ace/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/ace/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/ace/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/ace/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/ace/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    keys_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/acts_as_textiled/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/acts_as_textiled/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/acts_as_textiled/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/acts_as_textiled/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/ambition/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/ambition/teams",
    hooks_url: "https://api.github.com/repos/defunkt/ambition/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/ambition/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/ambition/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/ambition/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/ambition/branches{/branch}",
    ...
    git_tags_url:
      "https://api.github.com/repos/defunkt/ambition/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/ambition/git/refs{/sha}",
    trees_url: "https://api.github.com/repos/defunkt/ambition/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/ambition/statuses/{sha}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/ambition/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/ambition/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/ambition/subscription",
    commits_url: "https://api.github.com/repos/defunkt/ambition/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/ambition/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/ambition/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/ambition/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/ambition/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/ambition/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/ambition/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/ambition/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/ambition/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/ambition/notifications{?since,all,participating}",
    ...
    deployments_url:
      "https://api.github.com/repos/defunkt/ambition/deployments",
    created_at: "2008-01-14T06:28:56Z",
    updated_at: "2022-12-12T07:44:06Z",
  ...
  },
  {
    ...
    forks_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/forks",
    keys_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/collaborators{/collaborator}",
    teams_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/teams",
    hooks_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/issues/events{/number}",
    events_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/ambitious_activeldap/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/compare/{base}...{head}",
    merges_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/ambitious_activeldap/deployments",
  ...
  },
  {
    ...
    forks_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/forks",
    keys_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/collaborators{/collaborator}",
    teams_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/teams",
    hooks_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/issues/events{/number}",
    events_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/branches{/branch}",
    tags_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/compare/{base}...{head}",
    merges_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/ambitious_activerecord/deployments",
  ...
  },
  {
    ...
    keys_url:
      "https://api.github.com/repos/defunkt/barefootexamples/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/barefootexamples/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/barefootexamples/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/barefootexamples/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/barefootexamples/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/barefootexamples/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/barefootexamples/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/barefootexamples/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/barefootexamples/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/barefootexamples/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/barefootexamples/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/barefootexamples/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/barefootexamples/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/barefootexamples/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/barefootexamples/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/barefootexamples/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/barefootexamples/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/barefootexamples/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/barefootexamples/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/barefootexamples/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/barefootexamples/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/barefootexamples/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/barefootexamples/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/barefootexamples/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/barefootexamples/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/barefootexamples/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/barefootexamples/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/barefootexamples/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/barefootexamples/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/barefootexamples/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/barefootexamples/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/barefootexamples/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/barefootexamples/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/body_matcher/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/body_matcher/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/body_matcher/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/body_matcher/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/body_matcher/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/body_matcher/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/body_matcher/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/body_matcher/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/body_matcher/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/body_matcher/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/body_matcher/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/body_matcher/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/body_matcher/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/body_matcher/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/body_matcher/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/body_matcher/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/body_matcher/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/body_matcher/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/body_matcher/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/body_matcher/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/body_matcher/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/body_matcher/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/body_matcher/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/body_matcher/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/body_matcher/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/body_matcher/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/body_matcher/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/body_matcher/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/body_matcher/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/body_matcher/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/body_matcher/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/body_matcher/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/burn/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/burn/teams",
    hooks_url: "https://api.github.com/repos/defunkt/burn/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/burn/issues/events{/number}",
    ...
    git_commits_url:
      "https://api.github.com/repos/defunkt/burn/git/commits{/sha}",
    comments_url: "https://api.github.com/repos/defunkt/burn/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/burn/issues/comments{/number}",
    contents_url: "https://api.github.com/repos/defunkt/burn/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/burn/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/burn/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/burn/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/burn/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/burn/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/cache_fu/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/cache_fu/teams",
    hooks_url: "https://api.github.com/repos/defunkt/cache_fu/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/cache_fu/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/cache_fu/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/cache_fu/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/cache_fu/branches{/branch}",
    ...
    git_tags_url:
      "https://api.github.com/repos/defunkt/cache_fu/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/cache_fu/git/refs{/sha}",
    trees_url: "https://api.github.com/repos/defunkt/cache_fu/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/cache_fu/statuses/{sha}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/cache_fu/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/cache_fu/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/cache_fu/subscription",
    commits_url: "https://api.github.com/repos/defunkt/cache_fu/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/cache_fu/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/cache_fu/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/cache_fu/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/cache_fu/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/cache_fu/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/cache_fu/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/cache_fu/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/cache_fu/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/cache_fu/notifications{?since,all,participating}",
    ...
    deployments_url:
      "https://api.github.com/repos/defunkt/cache_fu/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/cheat/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/cheat/teams",
    hooks_url: "https://api.github.com/repos/defunkt/cheat/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/cheat/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/cheat/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/cheat/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/cheat/branches{/branch}",
    ...
    git_commits_url:
      "https://api.github.com/repos/defunkt/cheat/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/cheat/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/cheat/issues/comments{/number}",
    contents_url: "https://api.github.com/repos/defunkt/cheat/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/cheat/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/cheat/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/cheat/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/cheat/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/cheat/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/cheat.el/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/cheat.el/teams",
    hooks_url: "https://api.github.com/repos/defunkt/cheat.el/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/cheat.el/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/cheat.el/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/cheat.el/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/cheat.el/branches{/branch}",
    ...
    git_tags_url:
      "https://api.github.com/repos/defunkt/cheat.el/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/cheat.el/git/refs{/sha}",
    trees_url: "https://api.github.com/repos/defunkt/cheat.el/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/cheat.el/statuses/{sha}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/cheat.el/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/cheat.el/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/cheat.el/subscription",
    commits_url: "https://api.github.com/repos/defunkt/cheat.el/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/cheat.el/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/cheat.el/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/cheat.el/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/cheat.el/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/cheat.el/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/cheat.el/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/cheat.el/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/cheat.el/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/cheat.el/notifications{?since,all,participating}",
    ...
    deployments_url:
      "https://api.github.com/repos/defunkt/cheat.el/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/choice/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/choice/teams",
    hooks_url: "https://api.github.com/repos/defunkt/choice/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/choice/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/choice/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/choice/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/choice/branches{/branch}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/choice/contributors",
    subscribers_url: "https://api.github.com/repos/defunkt/choice/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/choice/subscription",
    commits_url: "https://api.github.com/repos/defunkt/choice/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/choice/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/choice/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/choice/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/choice/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/choice/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/choice/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/choice/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/choice/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/choice/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/cijoe/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/cijoe/teams",
    hooks_url: "https://api.github.com/repos/defunkt/cijoe/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/cijoe/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/cijoe/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/cijoe/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/cijoe/branches{/branch}",
    ...
    git_commits_url:
      "https://api.github.com/repos/defunkt/cijoe/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/cijoe/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/cijoe/issues/comments{/number}",
    contents_url: "https://api.github.com/repos/defunkt/cijoe/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/cijoe/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/cijoe/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/cijoe/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/cijoe/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/cijoe/notifications{?since,all,participating}",
    ...
    updated_at: "2023-02-15T23:10:57Z",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/coffee-mode/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/coffee-mode/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/coffee-mode/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/coffee-mode/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/coffee-mode/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/coffee-mode/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/coffee-mode/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/coffee-mode/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/coffee-mode/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/coffee-mode/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/coffee-mode/statuses/{sha}",
    languages_url: "https://api.github.com/repos/defunkt/coffee-mode/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/coffee-mode/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/coffee-mode/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/coffee-mode/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/coffee-mode/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/coffee-mode/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/coffee-mode/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/coffee-mode/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/coffee-mode/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/coffee-mode/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/coffee-mode/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/coffee-mode/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/coffee-mode/{archive_format}{/ref}",
    downloads_url: "https://api.github.com/repos/defunkt/coffee-mode/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/coffee-mode/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/coffee-mode/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/coffee-mode/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/coffee-mode/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/coffee-mode/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/coffee-mode/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/coffee-mode/deployments",
    created_at: "2010-03-07T08:30:40Z",
    updated_at: "2023-02-23T07:15:44Z",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/colored/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/colored/teams",
    hooks_url: "https://api.github.com/repos/defunkt/colored/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/colored/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/colored/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/colored/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/colored/branches{/branch}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/colored/contributors",
    subscribers_url: "https://api.github.com/repos/defunkt/colored/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/colored/subscription",
    commits_url: "https://api.github.com/repos/defunkt/colored/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/colored/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/colored/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/colored/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/colored/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/colored/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/colored/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/colored/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/colored/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/colored/notifications{?since,all,participating}",
    ...
    updated_at: "2022-11-04T13:21:36Z",
  ...
  },
  {
    ...
    keys_url:
      "https://api.github.com/repos/defunkt/currency_converter/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/currency_converter/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/currency_converter/issues/events{/number}",
    events_url:
      "https://api.github.com/repos/defunkt/currency_converter/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/currency_converter/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/currency_converter/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/currency_converter/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/currency_converter/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/currency_converter/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/currency_converter/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/currency_converter/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/currency_converter/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/currency_converter/languages",
    stargazers_url:
    ...
    subscribers_url:
      "https://api.github.com/repos/defunkt/currency_converter/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/currency_converter/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/currency_converter/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/currency_converter/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/currency_converter/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/currency_converter/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/currency_converter/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/currency_converter/compare/{base}...{head}",
    merges_url:
      "https://api.github.com/repos/defunkt/currency_converter/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/currency_converter/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/currency_converter/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/currency_converter/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/currency_converter/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/currency_converter/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/currency_converter/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/currency_converter/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/currency_converter/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/currency_converter/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/d3/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/d3/teams",
    hooks_url: "https://api.github.com/repos/defunkt/d3/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/d3/issues/events{/number}",
    ...
    git_commits_url:
      "https://api.github.com/repos/defunkt/d3/git/commits{/sha}",
    comments_url: "https://api.github.com/repos/defunkt/d3/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/d3/issues/comments{/number}",
    contents_url: "https://api.github.com/repos/defunkt/d3/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/d3/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/d3/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/d3/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/d3/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/d3/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    keys_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/issues/events{/number}",
    events_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/defunkt.github.com/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/compare/{base}...{head}",
    merges_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/defunkt.github.com/deployments",
    created_at: "2008-12-17T07:53:14Z",
    updated_at: "2022-12-01T10:53:34Z",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/djangode/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/djangode/teams",
    hooks_url: "https://api.github.com/repos/defunkt/djangode/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/djangode/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/djangode/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/djangode/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/djangode/branches{/branch}",
    ...
    git_tags_url:
      "https://api.github.com/repos/defunkt/djangode/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/djangode/git/refs{/sha}",
    trees_url: "https://api.github.com/repos/defunkt/djangode/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/djangode/statuses/{sha}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/djangode/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/djangode/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/djangode/subscription",
    commits_url: "https://api.github.com/repos/defunkt/djangode/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/djangode/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/djangode/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/djangode/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/djangode/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/djangode/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/djangode/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/djangode/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/djangode/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/djangode/notifications{?since,all,participating}",
    ...
    deployments_url:
      "https://api.github.com/repos/defunkt/djangode/deployments",
  ...
  },
  {
    ...
    forks_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/forks",
    keys_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/collaborators{/collaborator}",
    teams_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/teams",
    hooks_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/issues/events{/number}",
    events_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/dodgeball.github.com/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/compare/{base}...{head}",
    merges_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/dodgeball.github.com/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/dotenv/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/dotenv/teams",
    hooks_url: "https://api.github.com/repos/defunkt/dotenv/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/dotenv/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/dotenv/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/dotenv/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/dotenv/branches{/branch}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/dotenv/contributors",
    subscribers_url: "https://api.github.com/repos/defunkt/dotenv/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/dotenv/subscription",
    commits_url: "https://api.github.com/repos/defunkt/dotenv/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/dotenv/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/dotenv/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/dotenv/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/dotenv/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/dotenv/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/dotenv/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/dotenv/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/dotenv/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/dotenv/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/dotjs/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/dotjs/teams",
    hooks_url: "https://api.github.com/repos/defunkt/dotjs/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/dotjs/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/dotjs/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/dotjs/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/dotjs/branches{/branch}",
    ...
    git_commits_url:
      "https://api.github.com/repos/defunkt/dotjs/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/dotjs/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/dotjs/issues/comments{/number}",
    contents_url: "https://api.github.com/repos/defunkt/dotjs/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/dotjs/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/dotjs/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/dotjs/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/dotjs/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/dotjs/notifications{?since,all,participating}",
    ...
    updated_at: "2023-01-11T20:30:35Z",
  ...
  },
  {
    ...
    keys_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/electron-wordwrap/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/electron-wordwrap/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/electron-wordwrap/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/electron-wordwrap/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/emacs/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/emacs/teams",
    hooks_url: "https://api.github.com/repos/defunkt/emacs/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/emacs/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/emacs/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/emacs/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/emacs/branches{/branch}",
    ...
    git_commits_url:
      "https://api.github.com/repos/defunkt/emacs/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/emacs/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/emacs/issues/comments{/number}",
    contents_url: "https://api.github.com/repos/defunkt/emacs/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/emacs/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/emacs/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/emacs/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/emacs/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/emacs/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    keys_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/issues/events{/number}",
    events_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/email_reply_parser/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/compare/{base}...{head}",
    merges_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/email_reply_parser/deployments",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/evilbot/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/evilbot/teams",
    hooks_url: "https://api.github.com/repos/defunkt/evilbot/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/evilbot/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/evilbot/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/evilbot/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/evilbot/branches{/branch}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/evilbot/contributors",
    subscribers_url: "https://api.github.com/repos/defunkt/evilbot/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/evilbot/subscription",
    commits_url: "https://api.github.com/repos/defunkt/evilbot/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/evilbot/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/evilbot/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/evilbot/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/evilbot/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/evilbot/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/evilbot/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/evilbot/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/evilbot/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/evilbot/notifications{?since,all,participating}",
    ...
    updated_at: "2022-10-23T14:07:28Z",
  ...
  },
  {
    ...
    keys_url:
      "https://api.github.com/repos/defunkt/exception_logger/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/exception_logger/collaborators{/collaborator}",
    ...
    issue_events_url:
      "https://api.github.com/repos/defunkt/exception_logger/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/exception_logger/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/exception_logger/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/exception_logger/branches{/branch}",
    tags_url: "https://api.github.com/repos/defunkt/exception_logger/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/exception_logger/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/exception_logger/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/exception_logger/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/exception_logger/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/exception_logger/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/exception_logger/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/exception_logger/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/exception_logger/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/exception_logger/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/exception_logger/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/exception_logger/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/exception_logger/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/exception_logger/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/exception_logger/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/exception_logger/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/exception_logger/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/exception_logger/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/exception_logger/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/exception_logger/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/exception_logger/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/exception_logger/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/exception_logger/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/exception_logger/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/exception_logger/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/exception_logger/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/exception_logger/deployments",
    created_at: "2008-01-14T03:32:19Z",
    updated_at: "2023-02-13T07:50:18Z",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/facebox/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/facebox/teams",
    hooks_url: "https://api.github.com/repos/defunkt/facebox/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/facebox/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/facebox/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/facebox/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/facebox/branches{/branch}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/facebox/contributors",
    subscribers_url: "https://api.github.com/repos/defunkt/facebox/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/facebox/subscription",
    commits_url: "https://api.github.com/repos/defunkt/facebox/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/facebox/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/facebox/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/facebox/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/facebox/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/facebox/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/facebox/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/facebox/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/facebox/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/facebox/notifications{?since,all,participating}",
    ...
    updated_at: "2023-02-25T13:00:01Z",
  ...
  },
  {
    ...
    collaborators_url:
      "https://api.github.com/repos/defunkt/faceup/collaborators{/collaborator}",
    teams_url: "https://api.github.com/repos/defunkt/faceup/teams",
    hooks_url: "https://api.github.com/repos/defunkt/faceup/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/faceup/issues/events{/number}",
    events_url: "https://api.github.com/repos/defunkt/faceup/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/faceup/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/faceup/branches{/branch}",
    ...
    contributors_url:
      "https://api.github.com/repos/defunkt/faceup/contributors",
    subscribers_url: "https://api.github.com/repos/defunkt/faceup/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/faceup/subscription",
    commits_url: "https://api.github.com/repos/defunkt/faceup/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/faceup/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/faceup/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/faceup/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/faceup/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/faceup/compare/{base}...{head}",
    merges_url: "https://api.github.com/repos/defunkt/faceup/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/faceup/{archive_format}{/ref}",
    ...
    milestones_url:
      "https://api.github.com/repos/defunkt/faceup/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/faceup/notifications{?since,all,participating}",
  ...
  },
  {
    ...
    forks_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/forks",
    keys_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/keys{/key_id}",
    collaborators_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/collaborators{/collaborator}",
    teams_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/teams",
    hooks_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/hooks",
    issue_events_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/issues/events{/number}",
    events_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/events",
    assignees_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/assignees{/user}",
    branches_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/branches{/branch}",
    tags_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/tags",
    blobs_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/git/blobs{/sha}",
    git_tags_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/git/tags{/sha}",
    git_refs_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/git/refs{/sha}",
    trees_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/git/trees{/sha}",
    statuses_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/statuses/{sha}",
    languages_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/languages",
    stargazers_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/stargazers",
    contributors_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/contributors",
    subscribers_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/subscribers",
    subscription_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/subscription",
    commits_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/commits{/sha}",
    git_commits_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/git/commits{/sha}",
    comments_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/comments{/number}",
    issue_comment_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/issues/comments{/number}",
    contents_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/contents/{+path}",
    compare_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/compare/{base}...{head}",
    merges_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/merges",
    archive_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/{archive_format}{/ref}",
    downloads_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/downloads",
    issues_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/issues{/number}",
    pulls_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/pulls{/number}",
    milestones_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/milestones{/number}",
    notifications_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/notifications{?since,all,participating}",
    labels_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/labels{/name}",
    releases_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/releases{/id}",
    deployments_url:
      "https://api.github.com/repos/defunkt/fixture_scenarios_builder/deployments",
